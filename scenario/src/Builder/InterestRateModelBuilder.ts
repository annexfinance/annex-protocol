...
export async function buildInterestRateModel(world: World, from: string, event: Event): Promise<{world: World, interestRateModel: InterestRateModel, interestRateModelData: InterestRateModelData}> {
  const fetchers = [
    new Fetcher<{name: StringA, rate: NumberA}, InterestRateModelData>(`
        #### Fixed
    ...
    new Fetcher<{name: StringA, baseRate: NumberA, multiplier: NumberA}, InterestRateModelData>(`
        #### WhitePaper
      ...
      [
        new Arg("name", getStringA),
        new Arg("baseRate", getExpNumberA),
        new Arg("multiplier", getExpNumberA)
      ],
    ...
    new Fetcher<{name: StringA, baseRate: NumberA, multiplier: NumberA, jump: NumberA, kink: NumberA}, InterestRateModelData>(`
         #### JumpRateModel
       ...
       [
         ...
         new Arg("baseRate", getExpNumberA),
         new Arg("multiplier", getExpNumberA),
         new Arg("jump", getExpNumberA),
         new Arg("kink", getExpNumberA)
       ],
    ...
    new Fetcher<{name: StringA, jump: NumberA, kink: NumberA, pot: AddressA, jug: AddressA}, InterestRateModelData>(`
       ...
       [
         ...
         new Arg("jump", getExpNumberA),
         new Arg("kink", getExpNumberA),
         new Arg("pot", getAddressA),
         new Arg("jug", getAddressA)
       ],
