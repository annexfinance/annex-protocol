...
import { getAddressA, getNumberA } from '../CoreValue';
import { AddressA, NumberA } from '../Value';
...
export async function buildTimelock(
  ...
  const fetchers = [
    new Fetcher<{ admin: AddressA; delay: NumberA }, TimelockData>(
      `
        #### Scenario
      ...
      `,
      'Scenario',
      [new Arg('admin', getAddressA), new Arg('delay', getNumberA)],
