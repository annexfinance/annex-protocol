...
async function changesExpectation(world: World, condition: Event, delta: NumberA, tolerance: NumberA): Promise<World> {
...
export function expectationCommands() {
  return [
    new View<{condition: EventV, delta: NumberA, tolerance: NumberA}>(`
        #### Changes
      ...
      [
        ...
        new Arg("delta", getNumberA),
        new Arg("tolerance", getNumberA, {default: new NumberA(0)})
      ],
