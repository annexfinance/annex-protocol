...
export interface ANNScenarioMethods extends ANNMethods {
...
export interface ANN extends Contract {
  methods: ANNMethods;
  name: string;
}

export interface ANNScenario extends Contract {
  methods: ANNScenarioMethods;
  name: string;
}
