...
const XAIControllerErrorReporter = {
  Error: [
    'NO_ERROR',
    'UNAUTHORIZED',
    'REJECTION',
...
const TokenErrorReporter = {
  ...
  FailureInfo: [
    ...
    'XAI_MINT_NEW_ACCOUNT_BALANCE_CALCULATION_FAILED'
  ]
};
...
export const XAIControllerErr = parseEnum(XAIControllerErrorReporter);
