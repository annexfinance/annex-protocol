...
/**
  * @title Annex's DAIInterestRateModel Contract (version 2)
  * @author Annex (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Annex Protocol whitepaper.
