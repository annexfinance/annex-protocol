...
describe('ANN', () => {
  ...
  describe('balanceOf', () => {
    it('grants to initial account', async () => {
      expect(await call(ann, 'balanceOf', [root])).toEqual("30000000000000000000000000");
    });
  });
  ...
  describe('getPriorVotes', () => {
    ...
    it('returns the latest block if >= last checkpoint block', async () => {
      ...
      expect(await call(ann, 'getPriorVotes', [a1, t1.blockNumber])).toEqual('30000000000000000000000000');
      expect(await call(ann, 'getPriorVotes', [a1, t1.blockNumber + 1])).toEqual('30000000000000000000000000');
    });
    ...
    it('generally returns the voting balance at the appropriate checkpoint', async () => {
      ...
      expect(await call(ann, 'getPriorVotes', [a1, t1.blockNumber])).toEqual('30000000000000000000000000');
      expect(await call(ann, 'getPriorVotes', [a1, t1.blockNumber + 1])).toEqual('30000000000000000000000000');
      expect(await call(ann, 'getPriorVotes', [a1, t2.blockNumber])).toEqual('29999999999999999999999990');
      expect(await call(ann, 'getPriorVotes', [a1, t2.blockNumber + 1])).toEqual('29999999999999999999999990');
      expect(await call(ann, 'getPriorVotes', [a1, t3.blockNumber])).toEqual('29999999999999999999999980');
      expect(await call(ann, 'getPriorVotes', [a1, t3.blockNumber + 1])).toEqual('29999999999999999999999980');
      expect(await call(ann, 'getPriorVotes', [a1, t4.blockNumber])).toEqual('30000000000000000000000000');
      expect(await call(ann, 'getPriorVotes', [a1, t4.blockNumber + 1])).toEqual('30000000000000000000000000');
    });
  });
});
